...
return [
	...
	'backup' => [
		 ...
		 */
		'temporary_directory' => storage_path('app/temp/backups'),
		 ...
		 */
		'tries' => env('BACKUP_ATTEMPTS', 1),

		/*
		 * The number of seconds to wait before attempting a new backup if the previous try failed
		 * Set to `0` for none
		 */
		'retry_delay' => env('BACKUP_RETRY_DELAY', 0),
	],
	...
	'cleanup' => [
		...
		'default_strategy' => [
			 ...
			 */
			'keep_all_backups_for_days' => env('BACKUP_RETENTION_ALL_MIN_DAYS', 7),
			 ...
			 */
			'keep_daily_backups_for_days' => env('BACKUP_RETENTION_DAILY_MIN_DAYS', 16),
			 ...
			 */
			'keep_weekly_backups_for_weeks' => env('BACKUP_RETENTION_WEEKLY_MIN_WEEKS', 8),

			/*
			 * After the "keep_weekly_backups_for_weeks" period is over, the most recent backup
			 * of that month will be kept. Older backups within the same month will be removed.
			 */
			'keep_monthly_backups_for_months' => env('BACKUP_RETENTION_MONTHLY_MIN_MONTHS', 4),

			/*
			 * After the "keep_monthly_backups_for_months" period is over, the most recent backup
			 * of that year will be kept. Older backups within the same year will be removed.
			 */
			'keep_yearly_backups_for_years' => env('BACKUP_RETENTION_YEARLY_MIN_YEARS', 2),
		 ...
		 */
		'tries' => env('BACKUP_CLEANUP_ATTEMPTS', 1),

		/*
		 * The number of seconds to wait before attempting a new cleanup if the previous try failed
		 * Set to `0` for none
		 */
		'retry_delay' => env('BACKUP_CLEANUP_RETRY_DELAY', 0),
	],
