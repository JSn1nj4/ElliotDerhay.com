...
<article class='my-12'>
	<x-blog.wrapper>
		...
		<div
			class='pt-3 mt-2 md:bg-none dark:rounded-lg dark:border dark:border-slate-600 dark:hover:border-bright-turquoise-500 dark:md:border-none dark:bg-neutral-950 dark:md:bg-transparent dark:p-4 dark:md:p-0'>
