<header id="header" class="flex-initial border-b-4 border-solid border-sea-green-500">
	<div class="container-flexible-large m-auto">
		<nav class="flex items-center justify-between flex-wrap bg-gray-900 relative">
			...
			<div class="block mr-3 border-l-2 border-solid border-sea-green-800 pl-3" id="theme-toggle-button">
				<button class="flex items-center text-sea-green-500 hover:text-gray-500 transition-colors duration-300" onclick="toDarkMode()" title="Switch to dark theme">
				...
				<button class="flex items-center text-sea-green-500 hover:text-gray-500 transition-colors duration-300" onclick="toLightMode()" title="Switch to light theme">
				...
				<button class="flex items-center text-sea-green-500 hover:text-gray-500 transition-colors duration-300" onclick="toSystemMode()" title="Switch to system default theme">
