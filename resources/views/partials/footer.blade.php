<footer
	class="dark:bg-black/60 flex-initial border-t-4 border-solid border-bright-turquoise-900 dark:border-bright-turquoise-500 transition-[border-width] fun:border-0">
