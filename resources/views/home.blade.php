...
@section('content')
	...
	<x-row class="bg-laptop" id="about" overlay-classes="bg-sea-green-100 bg-opacity-50 dark:bg-sea-green-800 dark:bg-opacity-75">
		<x-column class="flex md:order-2 md:w-1/2 lg:w-5/12 xl:w-1/3">
			<img src="{{ \App\Services\ImageService::asset("Elliot.Color2-hd-v2-square.jpg") }}" title="Elliot Derhay" alt="Photo of Elliot Derhay" class="border-black dark:border-white border-2 border-opacity-40 rounded-full">
		</x-column>
