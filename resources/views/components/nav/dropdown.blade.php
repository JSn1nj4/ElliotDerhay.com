			...
			<div
				...
				<div class='{{ $triangleWrapperClasses }}'>
					<div class='relative h-full w-full'>
						...
						<div
							class='absolute bottom-0 left-[0.23rem] border-solid border-b-[1.2rem] border-b-big-stone-200 dark:border-b-big-stone-950 fun:border-b-big-stone-950 border-x-[0.85rem] border-x-transparent'></div>
						<div
