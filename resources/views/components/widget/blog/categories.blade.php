...
<x-widget.wrapper title="Categories">
	...
	@else
		<ul class='list-none lg:list-disc pl-0 lg:pl-5 overflow-hidden'>
			@foreach($categories as $category)
				<li
					class='float-left clear-both lg:float-none my-1 lg:my-0 border border-slate-600 lg:border-0 rounded lg:rounded-none bg-neutral-950 lg:bg-transparent px-2 py-1 lg:p-0'>
