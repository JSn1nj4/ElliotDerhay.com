<nav class="flex items-center justify-between flex-wrap bg-white dark:bg-black relative">
	...
	<div class="block lg:hidden mr-4">
		<label for="menu-toggle" class="flex items-center text-seaGreen-900 dark:text-seaGreen-500 hover:text-seaGreen-600 dark:hover:text-white transition-colors duration-300">
	...
	<div class="block mr-3 border-l-2 border-solid border-seaGreen-600 dark:border-seaGreen-800 pl-3" id="theme-toggle-button">
		<button class="flex items-center text-seaGreen-800 dark:text-seaGreen-500 hover:text-neutral-700 dark:hover:text-neutral-500 transition-colors duration-300" onclick="toDarkMode()" title="Switch to dark theme">
		...
		<button class="flex items-center text-seaGreen-800 dark:text-seaGreen-500 hover:text-neutral-700 dark:hover:text-neutral-500 transition-colors duration-300" onclick="toLightMode()" title="Switch to light theme">
		...
		<button class="flex items-center text-seaGreen-800 dark:text-seaGreen-500 hover:text-neutral-700 dark:hover:text-neutral-500 transition-colors duration-300" onclick="toSystemMode()" title="Switch to system default theme">
