<nav class="flex items-center justify-between flex-wrap relative">
	...
	<div class="block mr-3 border-l-2 border-solid border-bright-turquoise-600 dark:border-bright-turquoise-800 pl-3"
		...
		<button
			class="flex items-center text-bright-turquoise-800 dark:text-bright-turquoise-500 hover:text-neutral-700 dark:hover:text-neutral-500 transition-colors duration-300"
			onclick="toFunMode()" title="Switch to fun theme">
		...
		<button
			class="flex items-center text-bright-turquoise-800 dark:text-bright-turquoise-500 fun:text-bright-turquoise-500 hover:text-neutral-700 dark:hover:text-neutral-500 fun:hover:text-neutral-500 transition-colors duration-300"
			onclick="toSystemMode()" title="Switch to system default theme">
			<svg xmlns="http://www.w3.org/2000/svg"
					 class='fun-mode-icon size-8 '
					 viewBox="0 0 24 24"
					 stroke='currentColor'>
				<!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
				<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1"
							class='fill-bright-turquoise-800 dark:fill-bright-turquoise-500 fun:fill-bright-turquoise-500'
