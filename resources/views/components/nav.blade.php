<nav class="flex items-center justify-between flex-wrap bg-white dark:bg-black relative">
	...
	<div class="flex items-center flex-grow lg:flex-shrink-0 text-white">
		<a href="/" class="text-black dark:text-white p-2">
			<img src="{{ asset_url("avatar.png") }}" width="60" height="60" alt="ElliotDerhay.com logo" title="Elliot Derhay" class="inline border-solid border-2 border-black dark:border-white rounded-full align-middle">
	...
	<div class="block lg:hidden mr-4">
		<label for="menu-toggle" class="flex items-center text-caribbeanGreen-900 dark:text-caribbeanGreen-500 hover:text-caribbeanGreen-600 dark:hover:text-white transition-colors duration-300">
	...
	<div class="block mr-3 border-l-2 border-solid border-caribbeanGreen-600 dark:border-caribbeanGreen-800 pl-3" id="theme-toggle-button">
		<button class="flex items-center text-caribbeanGreen-800 dark:text-caribbeanGreen-500 hover:text-neutral-700 dark:hover:text-neutral-500 transition-colors duration-300" onclick="toDarkMode()" title="Switch to dark theme">
		...
		<button class="flex items-center text-caribbeanGreen-800 dark:text-caribbeanGreen-500 hover:text-neutral-700 dark:hover:text-neutral-500 transition-colors duration-300" onclick="toLightMode()" title="Switch to light theme">
		...
		<button class="flex items-center text-caribbeanGreen-800 dark:text-caribbeanGreen-500 hover:text-neutral-700 dark:hover:text-neutral-500 transition-colors duration-300" onclick="toSystemMode()" title="Switch to system default theme">
