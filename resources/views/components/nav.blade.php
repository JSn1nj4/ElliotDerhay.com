<nav class="flex items-center justify-between flex-wrap bg-white dark:bg-black relative">
	...
	<div class="block lg:hidden mr-4">
		<label for="menu-toggle" class="flex items-center text-sea-green-900 dark:text-sea-green-500 hover:text-sea-green-600 dark:hover:text-white transition-colors duration-300">
	...
	<div class="block mr-3 border-l-2 border-solid border-sea-green-600 dark:border-sea-green-800 pl-3" id="theme-toggle-button">
		<button class="flex items-center text-sea-green-800 dark:text-sea-green-500 hover:text-gray-700 dark:hover:text-gray-500 transition-colors duration-300" onclick="toDarkMode()" title="Switch to dark theme">
		...
		<button class="flex items-center text-sea-green-800 dark:text-sea-green-500 hover:text-gray-700 dark:hover:text-gray-500 transition-colors duration-300" onclick="toLightMode()" title="Switch to light theme">
		...
		<button class="flex items-center text-sea-green-800 dark:text-sea-green-500 hover:text-gray-700 dark:hover:text-gray-500 transition-colors duration-300" onclick="toSystemMode()" title="Switch to system default theme">
