<nav class="flex items-center justify-between flex-wrap bg-white dark:bg-black relative">
	...
	<div class="block mr-3 border-l-2 border-solid border-seaGreen-600 dark:border-seaGreen-800 pl-3" id="theme-toggle-button">
		<button class="flex items-center text-seaGreen-800 dark:text-seaGreen-500 hover:text-gray-700 dark:hover:text-gray-500 transition-colors duration-300" onclick="toDarkMode()" title="Switch to dark theme">
		...
		<button class="flex items-center text-seaGreen-800 dark:text-seaGreen-500 hover:text-gray-700 dark:hover:text-gray-500 transition-colors duration-300" onclick="toLightMode()" title="Switch to light theme">
		...
		<button class="flex items-center text-seaGreen-800 dark:text-seaGreen-500 hover:text-gray-700 dark:hover:text-gray-500 transition-colors duration-300" onclick="toSystemMode()" title="Switch to system default theme">
