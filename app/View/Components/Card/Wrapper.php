...
class Wrapper extends Component
{
	...
	public array $typeClasses = [
		'default' => 'rounded-lg border border-slate-300 dark:border-slate-600 transition-colors hover:border-bright-turquoise-600 dark:hover:border-bright-turquoise-500 bg-white dark:bg-neutral-950',
		'transparent' => ''
	];
