...
class Wrapper extends Component
{
	...
	public array $typeClasses = [
		'default' => 'rounded-lg border border-neutral-300 dark:border-neutral-600 trans-border-color hover:border-seaGreen-600 dark:hover:border-seaGreen-500 bg-white dark:bg-neutral-950',
		'transparent' => ''
	];
